...
Get-ChildItem "Published/EventHorizon.*.nupkg" -Recurse | Select-Object FullName | ForEach-Object { dotnet nuget push $($_.FullName) -k $($env:NUGET_ORG_KEY) --source "https://api.nuget.org/v3/index.json" }
