...
public class UtilityLayerRenderer : CachedEntityObject, _IDisposable
{
    ...
    public static UtilityLayerRenderer DefaultKeepDepthUtilityLayer
    {
        get
        {
            ...
            {
                __DefaultKeepDepthUtilityLayer =
                    EventHorizonBlazorInterop.GetClass<UtilityLayerRenderer>(
                        "BABYLON",
    ...
    public Scene originalScene
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "originalScene", value);
        }
    }
    ...
    public bool shouldRender
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "shouldRender", value);
        }
    }
    ...
    )
    {
        return EventHorizonBlazorInterop.FuncClass<Camera>(
            ...
            new object[]
            {
                new string[] { this.___guid, "getRenderCamera" },
    ...
    public string mainSceneTrackerPredicate(Func<Task> callback)
    {
        ...
        _mainSceneTrackerPredicateActionMap.Add(handle, callback);

        return handle;
    }

    public bool mainSceneTrackerPredicate_Remove(string handle)
    {
        return _mainSceneTrackerPredicateActionMap.Remove(handle);
    }
