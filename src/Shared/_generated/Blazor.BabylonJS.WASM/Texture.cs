...
public class Texture : BaseTexture
{
    ...
    public static Texture CreateFromBase64String(
        string data,
        string name,
        Scene scene,
    ...
    public static Texture LoadFromDataString(
        string name,
        object buffer,
        Scene scene,
    ...
    public decimal uOffset
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "uOffset", value);
        }
    }
    ...
    public decimal vOffset
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "vOffset", value);
        }
    }
    ...
    public decimal uScale
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "uScale", value);
        }
    }
    ...
    public decimal vScale
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "vScale", value);
        }
    }
    ...
    public decimal uAng
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "uAng", value);
        }
    }
    ...
    public decimal vAng
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "vAng", value);
        }
    }
    ...
    public decimal wAng
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "wAng", value);
        }
    }
