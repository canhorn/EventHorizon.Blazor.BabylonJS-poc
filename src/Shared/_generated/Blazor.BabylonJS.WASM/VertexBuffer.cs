...
public class VertexBuffer : CachedEntityObject
{
    ...
    public static void ForEach(
        ...
        decimal byteOffset,
        decimal byteStride,
        decimal componentCount,
        decimal componentType,
        decimal count,
        bool normalized,
    ...
    )
    {
        EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "BABYLON", "VertexBuffer", "ForEach" },
                data,
                byteOffset,
                byteStride,
                componentCount,
    ...
    public VertexBuffer(ICachedEntity entity)
        : base(entity)
    {
    ...
    public VertexBuffer(
        ...
        System.Nullable<bool> normalized = null,
    ...
    public string getKind()
    {
        return EventHorizonBlazorInterop.Func<string>(
            new object[] { new string[] { this.___guid, "getKind" } }
        );
    }
    ...
    {
        return EventHorizonBlazorInterop.Func<decimal>(
            new object[] { new string[] { this.___guid, "getOffset" } }
        );
    }
    ...
    {
        return EventHorizonBlazorInterop.Func<bool>(
            new object[] { new string[] { this.___guid, "getIsInstanced" } }
        );
    }
    ...
    {
        return EventHorizonBlazorInterop.Func<decimal>(
            new object[] { new string[] { this.___guid, "getInstanceDivisor" } }
        );
    }
