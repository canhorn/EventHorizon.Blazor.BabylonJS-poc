...
public class SceneLoader : CachedEntityObject
{
    ...
    public static void ImportMeshAsync(
        object meshNames,
        string rootUrl,
        string sceneFilename = null,
        Scene scene = null,
    ...
    )
    {
        EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "BABYLON", "SceneLoader", "ImportMeshAsync" },
                meshNames,
                rootUrl,
                sceneFilename,
                scene,
    ...
    )
    {
        EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "BABYLON", "SceneLoader", "LoadAsync" },
                rootUrl,
                sceneFilename,
                engine,
                onProgress,
    ...
    public static void AppendAsync(
        string rootUrl,
        string sceneFilename = null,
        Scene scene = null,
        ActionCallback<SceneLoaderProgressEvent> onProgress = null,
    ...
    )
    {
        EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "BABYLON", "SceneLoader", "AppendAsync" },
                rootUrl,
                sceneFilename,
                scene,
                onProgress,
    ...
    public static void LoadAssetContainerAsync(
        string rootUrl,
        string sceneFilename = null,
        Scene scene = null,
        ActionCallback<SceneLoaderProgressEvent> onProgress = null,
    ...
    public static void ImportAnimations(
        ...
        ActionCallback<CachedEntity> targetConverter = null,
        ActionCallback<Scene> onSuccess = null,
        ActionCallback<SceneLoaderProgressEvent> onProgress = null,
        ActionCallback<Scene, string, CachedEntity> onError = null
    )
    {
        EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "BABYLON", "SceneLoader", "ImportAnimations" },
                rootUrl,
                sceneFilename,
                scene,
                overwriteAnimations,
    ...
    public static void ImportAnimationsAsync(
        string rootUrl,
        string sceneFilename = null,
        Scene scene = null,
        System.Nullable<bool> overwriteAnimations = null,
