...
public class AssetContainer : AbstractScene
{
    ...
    public string instantiateModelsToScene(Func<string, Task> callback)
    {
        ...
        _instantiateModelsToSceneActionMap.Add(handle, callback);

        return handle;
    }

    public bool instantiateModelsToScene_Remove(string handle)
    {
        return _instantiateModelsToSceneActionMap.Remove(handle);
    }
