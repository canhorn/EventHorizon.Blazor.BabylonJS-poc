...
public class TransformNode : Node
{
    ...
    public static TransformNode Parse(
        object parsedTransformNode,
        Scene scene,
        string rootUrl
    )
    {
    ...
    public Observable<TransformNode> onAfterWorldMatrixUpdateObservable
    {
        get
        {
            ...
            {
                __onAfterWorldMatrixUpdateObservable =
    ...
    public TransformNode updatePoseMatrix(Matrix matrix)
    {
        return EventHorizonBlazorInterop.FuncClass<TransformNode>(
            ...
            new object[]
            {
                new string[] { this.___guid, "updatePoseMatrix" },
                matrix
            }
        );
    }
    ...
    public TransformNode setPreTransformMatrix(Matrix matrix)
    {
        return EventHorizonBlazorInterop.FuncClass<TransformNode>(
            ...
            new object[]
            {
                new string[] { this.___guid, "setPreTransformMatrix" },
                matrix
            }
        );
    }
    ...
    public TransformNode locallyTranslate(Vector3 vector3)
    {
        return EventHorizonBlazorInterop.FuncClass<TransformNode>(
            ...
            new object[]
            {
                new string[] { this.___guid, "locallyTranslate" },
                vector3
            }
        );
    }
    ...
    public TransformNode setPivotPoint(
        Vector3 point,
        System.Nullable<int> space = null
    )
    {
        return EventHorizonBlazorInterop.FuncClass<TransformNode>(
            ...
            new object[]
            {
                new string[] { this.___guid, "setPivotPoint" },
                point,
                space
            }
        );
    ...
    public TransformNode getPivotPointToRef(Vector3 result)
    {
        return EventHorizonBlazorInterop.FuncClass<TransformNode>(
            ...
            new object[]
            {
                new string[] { this.___guid, "getPivotPointToRef" },
                result
            }
        );
    }
    ...
    public TransformNode getAbsolutePivotPointToRef(Vector3 result)
    {
        return EventHorizonBlazorInterop.FuncClass<TransformNode>(
            ...
            new object[]
            {
                new string[] { this.___guid, "getAbsolutePivotPointToRef" },
                result
            }
        );
    }
    ...
    public TransformNode attachToBone(
        Bone bone,
    ...
    public TransformNode rotateAround(
        Vector3 point,
        Vector3 axis,
        decimal amount
    )
    {
        return EventHorizonBlazorInterop.FuncClass<TransformNode>(
            ...
            new object[]
            {
                new string[] { this.___guid, "rotateAround" },
                point,
                axis,
                amount
            }
    ...
    public TransformNode addRotation(decimal x, decimal y, decimal z)
    {
        return EventHorizonBlazorInterop.FuncClass<TransformNode>(
            ...
            new object[]
            {
                new string[] { this.___guid, "addRotation" },
                x,
                y,
                z
            }
    ...
    public void resetLocalMatrix(
        System.Nullable<bool> independentOfChildren = null
    )
    {
    ...
    private readonly IDictionary<
        string,
        Func<TransformNode, Task>
    > _registerAfterWorldMatrixUpdateActionMap =
        new Dictionary<string, Func<TransformNode, Task>>();
    ...
    )
    {
        ...
        _registerAfterWorldMatrixUpdateActionMap.Add(handle, callback);

        return handle;
    }

    public bool registerAfterWorldMatrixUpdate_Remove(string handle)
    {
        return _registerAfterWorldMatrixUpdateActionMap.Remove(handle);
    }
    ...
    private readonly IDictionary<
        string,
        Func<TransformNode, Task>
    > _unregisterAfterWorldMatrixUpdateActionMap =
        new Dictionary<string, Func<TransformNode, Task>>();
    ...
    )
    {
        ...
        var handle = Guid.NewGuid().ToString();
        _unregisterAfterWorldMatrixUpdateActionMap.Add(handle, callback);

        return handle;
    }

    public bool unregisterAfterWorldMatrixUpdate_Remove(string handle)
    {
        return _unregisterAfterWorldMatrixUpdateActionMap.Remove(handle);
    }
    ...
    {
        foreach (
            var action in _unregisterAfterWorldMatrixUpdateActionMap.Values
        )
        {
            await action(mesh);
        }
    ...
    public Vector3 getPositionInCameraSpace(Camera camera = null)
    {
        return EventHorizonBlazorInterop.FuncClass<Vector3>(
            ...
            new object[]
            {
                new string[] { this.___guid, "getPositionInCameraSpace" },
                camera
            }
        );
    }
    ...
    public decimal getDistanceToCamera(Camera camera = null)
    {
        return EventHorizonBlazorInterop.Func<decimal>(
            new object[]
            {
                new string[] { this.___guid, "getDistanceToCamera" },
                camera
            }
        );
    }
    ...
    public TransformNode[] getChildTransformNodes(
        ...
        ActionCallback<Node> predicate = null
    )
    {
