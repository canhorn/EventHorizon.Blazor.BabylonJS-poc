...
public class ColorCurves : CachedEntityObject
{
    ...
    public static void Bind(
        ...
        Effect effect,
        string positiveUniform = null,
        string neutralUniform = null,
        string negativeUniform = null
    )
    {
        EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "BABYLON", "ColorCurves", "Bind" },
                colorCurves,
                effect,
                positiveUniform,
                neutralUniform,
    ...
    public static void PrepareUniforms(string[] uniformsList)
    {
        EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
            {
                new string[] { "BABYLON", "ColorCurves", "PrepareUniforms" },
                uniformsList
            }
        );
    }
    ...
    public decimal globalHue
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "globalHue", value);
        }
    }
    ...
    public decimal globalDensity
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "globalDensity", value);
        }
    }
    ...
    public decimal highlightsHue
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "highlightsHue", value);
        }
    }
    ...
    public decimal midtonesHue
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "midtonesHue", value);
        }
    }
    ...
    public decimal shadowsHue
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "shadowsHue", value);
        }
    }
    ...
    public ColorCurves(ICachedEntity entity)
        : base(entity)
    {
