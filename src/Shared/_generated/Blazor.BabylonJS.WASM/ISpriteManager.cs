...
public class ISpriteManagerCachedEntity : CachedEntityObject, ISpriteManager
{
    ...
    public Sprite[] sprites
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "sprites", value);
        }
    }
    #endregion
    ...
    public ISpriteManagerCachedEntity(ICachedEntity entity)
        : base(entity) { }
    ...
    public PickingInfo intersects(
        Ray ray,
        Camera camera,
        ActionCallback<Sprite> predicate = null,
    ...
    public PickingInfo[] multiIntersects(
        Ray ray,
        Camera camera,
        ActionCallback<Sprite> predicate = null
    )
    {
        return EventHorizonBlazorInterop.FuncArrayClass<PickingInfo>(
            ...
            new object[]
            {
                new string[] { this.___guid, "multiIntersects" },
                ray,
                camera,
                predicate
            }
