...
public class Effect : CachedEntityObject, _IDisposable
{
    ...
    {
        EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { "BABYLON", "Effect", "ResetCache" } }
        );
    }
    #endregion
    ...
    public ActionCallback<Effect> onBind
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "onBind", value);
        }
    }
    ...
    public Effect(ICachedEntity entity)
        : base(entity) { }
    ...
    public string[] getAttributesNames()
    {
        return EventHorizonBlazorInterop.FuncArray<string>(
            new object[] { new string[] { this.___guid, "getAttributesNames" } }
        );
    }
    ...
    {
        return EventHorizonBlazorInterop.Func<decimal>(
            new object[] { new string[] { this.___guid, "getAttributesCount" } }
        );
    }
    ...
    {
        return EventHorizonBlazorInterop.FuncArray<string>(
            new object[] { new string[] { this.___guid, "getSamplers" } }
        );
    }
    ...
    public string executeWhenCompiled(Func<Effect, Task> callback)
    {
        ...
        _executeWhenCompiledActionMap.Add(handle, callback);

        return handle;
    }

    public bool executeWhenCompiled_Remove(string handle)
    {
        return _executeWhenCompiledActionMap.Remove(handle);
    }
