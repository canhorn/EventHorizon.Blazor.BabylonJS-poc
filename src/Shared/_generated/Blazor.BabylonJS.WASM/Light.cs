...
public class Light : Node
{
    ...
    public decimal intensityMode
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "intensityMode", value);
        }
    }
    ...
    public decimal lightmapMode
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "lightmapMode", value);
        }
    }
    #endregion
    ...
    public decimal falloffType
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "falloffType", value);
        }
    }
    ...
    public Light transferTexturesToEffect(Effect effect, string lightIndex)
    {
        return EventHorizonBlazorInterop.FuncClass<Light>(
            ...
            new object[]
            {
                new string[] { this.___guid, "transferTexturesToEffect" },
                effect,
                lightIndex
            }
        );
    ...
    {
        return EventHorizonBlazorInterop.Func<decimal>(
            new object[] { new string[] { this.___guid, "getScaledIntensity" } }
        );
    }
