...
public class Mesh : AbstractMesh, IGetSetVerticesData
{
    ...
    public static Mesh CreateHemisphere(
        string name,
        decimal segments,
        decimal diameter,
        Scene scene = null
    ...
    public bool isUnIndexed
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "isUnIndexed", value);
        }
    }
    ...
    public string updateMeshPositions(Func<decimal[], Task> callback)
    {
        ...
        var handle = Guid.NewGuid().ToString();
        _updateMeshPositionsActionMap.Add(handle, callback);

        return handle;
    }

    public bool updateMeshPositions_Remove(string handle)
    {
        return _updateMeshPositionsActionMap.Remove(handle);
    }
    ...
    public Mesh applyDisplacementMap(
        string url,
        decimal minHeight,
        decimal maxHeight,
    ...
    public Mesh applyDisplacementMapFromBuffer(
        decimal[] buffer,
    ...
    public string optimizeIndices(Func<Mesh, Task> callback)
    {
        ...
        var handle = Guid.NewGuid().ToString();
        _optimizeIndicesActionMap.Add(handle, callback);

        return handle;
    }

    public bool optimizeIndices_Remove(string handle)
    {
        return _optimizeIndicesActionMap.Remove(handle);
    }
