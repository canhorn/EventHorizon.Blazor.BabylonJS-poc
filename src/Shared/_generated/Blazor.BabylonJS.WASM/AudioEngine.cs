...
public class AudioEngine : CachedEntityObject, IAudioEngine
{
    ...
    public GainNode masterGain
    {
        ...
        {
            __masterGain = null;
            EventHorizonBlazorInterop.Set(this.___guid, "masterGain", value);
        }
    }
    ...
    public bool unlocked
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "unlocked", value);
        }
    }
    ...
    public Observable<AudioEngine> onAudioLockedObservable
    {
        get
        {
            ...
            {
                __onAudioLockedObservable = EventHorizonBlazorInterop.GetClass<
    ...
    public AudioEngine(ICachedEntity entity)
        : base(entity) { }

    public AudioEngine(CachedEntity hostElement = null)
        : base()
    {
