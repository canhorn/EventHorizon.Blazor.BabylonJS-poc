    ...
    where T : CachedEntity, new()
{
    ...
    public bool add_Remove(string handle)
    {
        return _addActionMap.Remove(handle);
    }
    ...
    public bool addOnce_Remove(string handle)
    {
        return _addOnceActionMap.Remove(handle);
    }
    ...
    public bool removeCallback_Remove(string handle)
    {
        return _removeCallbackActionMap.Remove(handle);
    }
    ...
    public void notifyObserversWithPromise(
        T eventData,
        System.Nullable<decimal> mask = null,
        object target = null,
        object currentTarget = null
