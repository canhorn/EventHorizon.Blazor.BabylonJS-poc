...
public class BoundingBoxGizmo : Gizmo
{
    ...
    public decimal scaleBoxSize
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "scaleBoxSize", value);
        }
    }
    ...
    public Observable<CachedEntity> onDragStartObservable
    {
        get
        {
            ...
            {
                __onDragStartObservable = EventHorizonBlazorInterop.GetClass<
    ...
    public Observable<CachedEntity> onScaleBoxDragObservable
    {
        get
        {
            ...
            {
                __onScaleBoxDragObservable = EventHorizonBlazorInterop.GetClass<
                    Observable<CachedEntity>
                >(
                    this.___guid,
    ...
    public Vector3 scalePivot
    {
        ...
        {
            __scalePivot = null;
            EventHorizonBlazorInterop.Set(this.___guid, "scalePivot", value);
        }
    }
    #endregion
    ...
    public void setColor(Color3 color)
    {
        EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { this.___guid, "setColor" }, color }
        );
    }
    ...
    {
        EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { this.___guid, "updateBoundingBox" } }
        );
    }
    ...
    {
        EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { this.___guid, "enableDragBehavior" } }
        );
    }
