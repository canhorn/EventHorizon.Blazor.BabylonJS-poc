...
public class Vector4 : CachedEntityObject
{
    ...
    public static Vector4 FromArray(
        decimal[] array,
    ...
    )
    {
        return EventHorizonBlazorInterop.FuncClass<Vector4>(
            ...
            new object[]
            {
                new string[] { "BABYLON", "Vector4", "FromArray" },
                array,
                offset
            }
        );
    ...
    public static Vector4 Normalize(Vector4 vector)
    {
        return EventHorizonBlazorInterop.FuncClass<Vector4>(
            ...
            new object[]
            {
                new string[] { "BABYLON", "Vector4", "Normalize" },
                vector
            }
        );
    }
    ...
    public static Vector4 Minimize(Vector4 left, Vector4 right)
    {
        return EventHorizonBlazorInterop.FuncClass<Vector4>(
            ...
            new object[]
            {
                new string[] { "BABYLON", "Vector4", "Minimize" },
                left,
                right
            }
        );
    ...
    public static Vector4 Maximize(Vector4 left, Vector4 right)
    {
        return EventHorizonBlazorInterop.FuncClass<Vector4>(
            ...
            new object[]
            {
                new string[] { "BABYLON", "Vector4", "Maximize" },
                left,
                right
            }
        );
    ...
    public static decimal Distance(Vector4 value1, Vector4 value2)
    {
        return EventHorizonBlazorInterop.Func<decimal>(
            new object[]
            {
                new string[] { "BABYLON", "Vector4", "Distance" },
                value1,
                value2
            }
        );
    ...
    public static Vector4 Center(Vector4 value1, Vector4 value2)
    {
        return EventHorizonBlazorInterop.FuncClass<Vector4>(
            ...
            new object[]
            {
                new string[] { "BABYLON", "Vector4", "Center" },
                value1,
                value2
            }
        );
    ...
    public static Vector4 FromVector3(
        Vector3 source,
    ...
    )
    {
        return EventHorizonBlazorInterop.FuncClass<Vector4>(
            ...
            new object[]
            {
                new string[] { "BABYLON", "Vector4", "FromVector3" },
                source,
                w
            }
        );
    ...
    public Vector4 subtractFromFloats(
        decimal x,
        decimal y,
        decimal z,
        decimal w
    ...
    public Vector4 subtractFromFloatsToRef(
        decimal x,
        decimal y,
        decimal z,
        decimal w,
