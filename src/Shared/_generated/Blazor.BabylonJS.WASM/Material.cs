...
public class Material : CachedEntityObject, IAnimatable
{
    ...
    )
    {
        return EventHorizonBlazorInterop.FuncClass<Material>(
            ...
            new object[]
            {
                new string[] { "BABYLON", "Material", "Parse" },
                parsedMaterial,
                scene,
                rootUrl
            }
    ...
    public decimal alphaMode
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "alphaMode", value);
        }
    }
    ...
    public bool wireframe
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "wireframe", value);
        }
    }
    ...
    public bool pointsCloud
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "pointsCloud", value);
        }
    }
    ...
    public ActionCallback<Effect> onCompiled
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "onCompiled", value);
        }
    }
    ...
    public ActionCallback<Effect, string> onError
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "onError", value);
        }
    }
    ...
    public decimal depthFunction
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "depthFunction", value);
        }
    }
    ...
    public void freeze()
    {
        EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { this.___guid, "freeze" } }
        );
    }
    ...
    {
        EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { this.___guid, "unfreeze" } }
        );
    }
    ...
    {
        EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[] { new string[] { this.___guid, "bindView" }, effect }
        );
    }
    ...
    public AbstractMesh[] getBindedMeshes()
    {
        return EventHorizonBlazorInterop.FuncArrayClass<AbstractMesh>(
            ...
            new object[] { new string[] { this.___guid, "getBindedMeshes" } }
        );
    }
