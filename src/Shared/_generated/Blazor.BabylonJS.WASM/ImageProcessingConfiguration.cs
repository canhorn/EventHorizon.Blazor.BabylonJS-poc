...
public class ImageProcessingConfiguration : CachedEntityObject
{
    ...
    public static void PrepareUniforms(
        string[] uniforms,
    ...
    public static void PrepareSamplers(
        string[] samplersList,
        IImageProcessingConfigurationDefines defines
    )
    {
    ...
    public Color4 vignetteColor
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "vignetteColor", value);
        }
    }
    ...
    public Observable<ImageProcessingConfiguration> onUpdateParameters
    {
        get
        {
            ...
            {
                __onUpdateParameters = EventHorizonBlazorInterop.GetClass<
                    Observable<ImageProcessingConfiguration>
                >(
                    this.___guid,
                    "onUpdateParameters",
                    (entity) =>
                    {
                        return new Observable<ImageProcessingConfiguration>()
                        {
    ...
    public ImageProcessingConfiguration(ICachedEntity entity)
        : base(entity)
    {
        ___guid = entity.___guid;
    }
    ...
    public void prepareDefines(
        IImageProcessingConfigurationDefines defines,
        System.Nullable<bool> forPostProcess = null
    )
    {
        EventHorizonBlazorInterop.Func<CachedEntity>(
            new object[]
