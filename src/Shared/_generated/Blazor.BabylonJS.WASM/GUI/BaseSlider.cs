...
public class BaseSlider : Control
{
    ...
    public bool displayThumb
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "displayThumb", value);
        }
    }
    ...
    public string barOffset
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "barOffset", value);
        }
    }
    ...
    public string thumbWidth
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "thumbWidth", value);
        }
    }
    ...
    public decimal minimum
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "minimum", value);
        }
    }
    ...
    public decimal maximum
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "maximum", value);
        }
    }
    ...
    public BaseSlider(ICachedEntity entity)
        : base(entity) { }

    public BaseSlider(string name = null)
        : base()
    {
