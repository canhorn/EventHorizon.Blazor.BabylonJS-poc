...
public class ValueAndUnit : CachedEntityObject
{
    ...
    public ValueAndUnit(ICachedEntity entity)
        : base(entity)
    {
    ...
    public ValueAndUnit(
        ...
        System.Nullable<bool> negativeValueAllowed = null
    )
    {
    ...
    {
        return EventHorizonBlazorInterop.Func<decimal>(
            new object[] { new string[] { this.___guid, "getValue" }, host }
        );
    }
    ...
    public bool fromString(string source)
    {
        return EventHorizonBlazorInterop.Func<bool>(
            new object[] { new string[] { this.___guid, "fromString" }, source }
        );
    }
    #endregion
}
