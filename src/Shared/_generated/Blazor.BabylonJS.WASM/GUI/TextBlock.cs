...
public class TextBlock : Control
{
    ...
    public bool resizeToFit
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "resizeToFit", value);
        }
    }
    ...
    public int textWrapping
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "textWrapping", value);
        }
    }
    ...
    public string text
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "text", value);
        }
    }
    ...
    public string lineSpacing
    {
        ...
        set
        {
            ...
            EventHorizonBlazorInterop.Set(this.___guid, "lineSpacing", value);
        }
    }
    ...
    public Observable<TextBlock> onTextChangedObservable
    {
        get
        {
            ...
            {
                __onTextChangedObservable = EventHorizonBlazorInterop.GetClass<
                    Observable<TextBlock>
                >(
                    this.___guid,
    ...
    public Observable<TextBlock> onLinesReadyObservable
    {
        get
        {
            ...
            {
                __onLinesReadyObservable = EventHorizonBlazorInterop.GetClass<
                    Observable<TextBlock>
                >(
                    this.___guid,
    ...
    public TextBlock(ICachedEntity entity)
        : base(entity) { }

    public TextBlock(string name = null, string text = null)
        : base()
    {
