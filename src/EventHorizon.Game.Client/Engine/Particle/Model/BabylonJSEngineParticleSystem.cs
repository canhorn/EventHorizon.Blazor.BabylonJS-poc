namespace EventHorizon.Game.Client.Engine.Particle.Model
{
    ...
    public class BabylonJSEngineParticleSystem
        : EngineParticleSystem
    {
        private readonly ParticleSettingsIntoParticleSystemMapper _mapper = GameServiceProvider.GetService<ParticleSettingsIntoParticleSystemMapper>();

        public long Id { get; }
        public ParticleSystem ParticleSystem { get; }

        public BabylonJSEngineParticleSystem(
            long id,
