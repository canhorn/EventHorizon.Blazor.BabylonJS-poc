namespace EventHorizon.Game.Client.Engine.Particle
{
    ...
    {
        public static IServiceCollection AddEngineParticleServices(
            this IServiceCollection services
        ) => services
            .AddSingleton<ParticleSettingsIntoParticleSystemMapper, BabylonJSParticleSettingsIntoParticleSystemMapper>()
            ...
            .AddSingleton<ParticleState>(services => services.GetRequiredService<BabylonJSParticleState>())
            .AddSingleton<ParticleLifecycleService>(services => services.GetRequiredService<BabylonJSParticleState>())
        ;
    }
}
