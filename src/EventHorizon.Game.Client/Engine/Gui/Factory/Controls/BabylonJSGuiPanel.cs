...
public class BabylonJSGuiPanel : IBabylonJSGuiControl
{
    ...
    private StackPanel CreateControl(string id, IGuiControlOptions options)
    {
        var stackPanelControl = new StackPanel($"{id}_stack-panel");

        Update(options, stackPanelControl);
