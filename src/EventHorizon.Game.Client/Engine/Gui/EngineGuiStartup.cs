...
{
    public static IServiceCollection AddEngineGuiServices(this IServiceCollection services) =>
        services
            .AddSingleton<IServiceEntity, GuiInitializePlatformService>()
            .AddSingleton<IGuiControlFactory, BabylonJSGuiControlFactory>()
            .AddSingleton<IGuiControlChildrenState, StandardGuiControlChildrenState>()
            .AddSingleton<IGuiControlState, StandardGuiControlState>()
            .AddSingleton<IGuiControlTemplateState, StandardGuiControlTemplateState>()
