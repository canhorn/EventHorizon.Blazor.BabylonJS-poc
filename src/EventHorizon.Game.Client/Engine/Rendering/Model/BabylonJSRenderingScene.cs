...
public class BabylonJSRenderingScene : IRenderingScene
{
    ...
    public BabylonJSRenderingScene(IRenderingEngine renderingEngine)
    {
    ...
    public Task Initialize()
    {
        ...
        _scene = new BabylonJSSceneImplementation(engine.Engine);
