...
public class BabylonJSVector3 : BabylonJS.Vector3, IVector3
{
    ...
    {
        return new BabylonJSVector3(clone());
    }

    public IVector3 Subtract(IVector3 currentPosition)
    {
        return new BabylonJSVector3(subtract(currentPosition.ToBabylonJS()));
    }
    ...
    public IVector3 Multiply(IVector3 vector3)
    {
        return new BabylonJSVector3(multiply(new BabylonJSVector3(vector3)));
    }

    public void AddInPlace(IVector3 vector3)
    {
        addInPlace(new BabylonJSVector3(vector3));
    }
