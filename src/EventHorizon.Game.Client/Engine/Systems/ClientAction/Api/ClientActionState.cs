...
{
    Option<IClientAction> Get(string actionName, IDictionary<string, object> data);
    Option<ExternalClientAction> GetExternal(string actionName, IDictionary<string, object> data);
