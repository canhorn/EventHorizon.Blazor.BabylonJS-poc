namespace EventHorizon.Game.Client.Engine.Systems.Entity.ClientAction
{
    ...
    public struct ClientActionServerClientEntityChangedEvent
        : IClientAction
    {
        ...
        : INotificationHandler<ClientActionServerClientEntityChangedEvent>
    {
        ...
        public ServerClientEntityChangedEventObserverHandler(
        ...
        ) => _observer.Trigger<ServerClientEntityChangedEventObserver, ClientActionServerClientEntityChangedEvent>(
            notification,
            cancellationToken
        );
    }
