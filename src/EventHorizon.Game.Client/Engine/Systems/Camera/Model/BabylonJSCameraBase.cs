...
public class BabylonJSCameraBase<T> : ClientEntityBase, ICamera
    where T : Camera
{
    protected readonly T _camera;

    public BabylonJSCameraBase(T camera)
    ...
    public bool IsInFrustum(IEngineMesh engineMesh)
    {
        ...
        {
            return _camera.isInFrustum(mesh.Mesh);
        }
        return false;
    }
    ...
    public void SetAsActive()
    {
        GameServiceProvider
            ...
            .GetBabylonJSScene()
            .Scene.setActiveCameraByID(_camera.id);
    }
}
