...
public interface GameLoadedEventObserver : ArgumentObserver<GameLoadedEvent> { }

public class GameLoadedEventHandler : INotificationHandler<GameLoadedEvent>
{
    private readonly ObserverState _observer;

    public GameLoadedEventHandler(ObserverState observer)
    {
        _observer = observer;
    }
