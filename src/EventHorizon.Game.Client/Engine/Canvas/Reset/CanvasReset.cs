...
namespace EventHorizon.Game.Client.Engine.Canvas.Reset
{
    ...
    public interface CanvasResetObserver
        : ArgumentObserver<CanvasReset>
    {
    }

    public class CanvasResetHandler
        : INotificationHandler<CanvasReset>
    {
        private readonly ObserverState _observer;

        public CanvasResetHandler(
