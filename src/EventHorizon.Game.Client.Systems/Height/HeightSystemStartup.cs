...
{
    public static IServiceCollection AddHeightSystemServices(this IServiceCollection services) =>
        services
            .AddSingleton<HeightResolver, HeightResolver>()
            .AddSingleton<IHeightResolver>(services =>
                services.GetRequiredService<HeightResolver>()
            )
            .AddSingleton<ISetHeightResolver>(services =>
                services.GetRequiredService<HeightResolver>()
            );
}
