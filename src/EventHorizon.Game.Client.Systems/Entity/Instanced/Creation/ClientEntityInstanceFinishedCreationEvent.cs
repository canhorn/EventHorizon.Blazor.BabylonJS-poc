namespace EventHorizon.Game.Client.Systems.Entity.Instanced.Creation
{
    ...
    public struct ClientEntityInstanceFinishedCreationEvent : INotification
    {
        ...
        public ClientEntityInstanceFinishedCreationEvent(
        ...
        : INotificationHandler<ClientEntityInstanceFinishedCreationEvent>
    {
        ...
        public ClientEntityInstanceRegisteredEventHandler(
        ...
        ) => _observer.Trigger<ClientEntityInstanceRegisteredEventObserver, ClientEntityInstanceFinishedCreationEvent>(
            notification,
            cancellationToken
        );
    }
