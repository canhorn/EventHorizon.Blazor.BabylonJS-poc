namespace EventHorizon.Game.Client.Systems.Entity.Moving
{
    ...
    public interface EntityMovingEventObserver
        : ArgumentObserver<EntityMovingEvent>
    {
    }

    public class EntityMovingEventHandler
        : INotificationHandler<EntityMovingEvent>
    {
        private readonly ObserverState _observer;

        public EntityMovingEventHandler(
        ...
        public Task Handle(
            EntityMovingEvent notification,
