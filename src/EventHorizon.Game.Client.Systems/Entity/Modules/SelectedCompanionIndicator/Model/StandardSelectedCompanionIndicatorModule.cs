        ...
        ClearPointerHitEntityEventObserver
{
    private readonly ILogger _logger = GameServiceProvider.GetService<
        ILogger<StandardSelectedCompanionIndicatorModule>
    >();
    ...
    public StandardSelectedCompanionIndicatorModule(IObjectEntity entity)
    {
        _entity = entity;
    ...
    public async Task Handle(CompanionSelectedEvent args)
    {
