namespace EventHorizon.Game.Client.Systems.Entity.Modules.ModelLoader.Loaded
{
    ...
    public interface MeshLoadedEventObserver
        : ArgumentObserver<MeshLoadedEvent>
    {
    }

    public class MeshLoadedEventHandler
        : INotificationHandler<MeshLoadedEvent>
    {
        private readonly ObserverState _observer;

        public MeshLoadedEventHandler(
