...
public interface RunInteractionEventObserver : ArgumentObserver<RunInteractionEvent> { }

public class RunInteractionEventObserverHandler : INotificationHandler<RunInteractionEvent>
{
    ...
    public Task Handle(RunInteractionEvent notification, CancellationToken cancellationToken) =>
