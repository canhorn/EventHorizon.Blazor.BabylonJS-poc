namespace EventHorizon.Game.Client.Systems.Entity.Modules.InteractionIndicator.Show
{
    ...
    public struct ShowInteractionIndicatorEvent
        : INotification
    {
        public long EntityId { get; }

        public ShowInteractionIndicatorEvent(
            long entityId
        )
        {
            EntityId = entityId;
        ...
        : INotificationHandler<ShowInteractionIndicatorEvent>
    {
        ...
        public ShowInteractionIndicatorEventHandler(
        ...
        ) => _observer.Trigger<ShowInteractionIndicatorEventObserver, ShowInteractionIndicatorEvent>(
            notification,
            cancellationToken
        );
    }
