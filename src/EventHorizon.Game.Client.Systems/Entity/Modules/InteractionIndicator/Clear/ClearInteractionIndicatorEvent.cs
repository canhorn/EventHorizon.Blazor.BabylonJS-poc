namespace EventHorizon.Game.Client.Systems.Entity.Modules.InteractionIndicator.Clear
{
    ...
    public struct ClearInteractionIndicatorEvent
        : INotification
    {
        ...
        : INotificationHandler<ClearInteractionIndicatorEvent>
    {
        ...
        public ClearInteractionIndicatorEventHandler(
        ...
        ) => _observer.Trigger<ClearInteractionIndicatorEventObserver, ClearInteractionIndicatorEvent>(
            notification,
            cancellationToken
        );
    }
