...
public interface ZoneChangedEventObserver : ArgumentObserver<ZoneChangedEvent> { }
...
public class ZoneChangedEventHandler : INotificationHandler<ZoneChangedEvent>
{
    ...
    public Task Handle(ZoneChangedEvent notification, CancellationToken cancellationToken) =>
