...
public record ClientActionParticleSystemReloadedEvent : IClientAction
{
    ...
    public ClientActionParticleSystemReloadedEvent(IClientActionDataResolver resolver)
    {
    ...
    : INotificationHandler<ClientActionParticleSystemReloadedEvent>
{
    ...
    public ClientActionParticleSystemReloadedEventObserverHandler(ObserverState observer)
    {
        _observer = observer;
    }
