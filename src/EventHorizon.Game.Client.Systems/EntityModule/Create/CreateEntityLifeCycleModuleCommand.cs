...
public class CreateEntityLifeCycleModuleCommand : IRequest<CommandResult<IEntityLifeCycleModule>>
{
    public EntityModuleScripts Scripts { get; }
    public ScriptData ScriptData { get; }

    public CreateEntityLifeCycleModuleCommand(EntityModuleScripts scripts, ScriptData scriptData)
    {
        Scripts = scripts;
