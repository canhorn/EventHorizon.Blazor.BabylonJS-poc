...
public record ClientActionEntityModuleSystemReloadedEvent : IClientAction
{
    ...
    public ClientActionEntityModuleSystemReloadedEvent(IClientActionDataResolver resolver)
    {
    ...
    : INotificationHandler<ClientActionEntityModuleSystemReloadedEvent>
{
    ...
    public ClientActionEntityModuleSystemReloadedEventObserverHandler(ObserverState observer)
    {
        _observer = observer;
    }
