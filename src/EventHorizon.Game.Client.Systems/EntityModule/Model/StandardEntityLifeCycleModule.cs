...
public class StandardEntityLifeCycleModule : ClientEntityBase, IEntityLifeCycleModule
{
    ...
    public Task Initialize()
    {
        ...
        {
            return _initializeScript.Value.Run(_scriptServices, _scriptData);
        }
    ...
    public Task Dispose()
    {
        ...
        {
            return _disposeScript.Value.Run(_scriptServices, _scriptData);
        }
        return Task.CompletedTask;
    }
    ...
    public Task Update()
    {
        return _runnableUpdateScript(_scriptServices, _scriptData);
    }
}
