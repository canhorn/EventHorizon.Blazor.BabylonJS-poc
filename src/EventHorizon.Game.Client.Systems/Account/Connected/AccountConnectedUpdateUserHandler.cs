...
public class AccountConnectedUpdateUserHandler : INotificationHandler<AccountConnectedEvent>
{
    private readonly IMediator _mediator;
    private readonly IAccountState _state;

    public AccountConnectedUpdateUserHandler(IMediator mediator, IAccountState state)
    {
        _mediator = mediator;
        _state = state;
    }
