namespace EventHorizon.Game.Client.Systems.Account.Changed
{
    ...
    public interface AccountChangedEventObserver
        : ArgumentObserver<AccountChangedEvent>
    {
    }

    public class AccountChangedEventHandler
        : INotificationHandler<AccountChangedEvent>
    {
        private readonly ObserverState _observer;

        public AccountChangedEventHandler(
        ...
        public Task Handle(
            AccountChangedEvent notification,
