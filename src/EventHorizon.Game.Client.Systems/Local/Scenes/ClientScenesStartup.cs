...
{
    public static IServiceCollection AddClientScenesServices(this IServiceCollection services) =>
        services.AddSingleton<ISceneOrchestratorState, StandardSceneOrchestratorState>();
}
