        ...
        EntityChangedSuccessfullyEventObserver
{
    ...
    private readonly IHeightResolver _heightResolver =
        GameServiceProvider.GetService<IHeightResolver>();

    public override int Priority => 0;

    public TransformModule(IObjectEntity entity)
    {
        _entity = entity;
    ...
    public void Reset(IVector3 position)
    {
    ...
    public Task Handle(SetEntityPositionEvent args)
    {
    ...
    {
        Reset(_entity.Transform.Position);
        return Task.CompletedTask;
    }

    public Task Handle(EntityChangedSuccessfullyEvent args)
    {
    ...
    private void SetAllPosition(IVector3 position)
    {
        var newPosition = new StandardVector3(position);
        ...
        _entity.Transform.Position.Set(newPosition);
    }
