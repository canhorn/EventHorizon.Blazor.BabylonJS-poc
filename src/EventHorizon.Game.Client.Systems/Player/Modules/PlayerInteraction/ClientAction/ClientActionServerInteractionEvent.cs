namespace EventHorizon.Game.Client.Systems.Player.Modules.PlayerInteraction.ClientAction
{
    ...
    public class ClientActionServerInteractionEvent
        : IClientAction
    {
        ...
        : INotificationHandler<ClientActionServerInteractionEvent>
    {
        ...
        public ClientActionServerInteractionEventHandler(
        ...
        ) => _observer.Trigger<ClientActionServerInteractionEventObserver, ClientActionServerInteractionEvent>(
            notification,
            cancellationToken
        );
    }
