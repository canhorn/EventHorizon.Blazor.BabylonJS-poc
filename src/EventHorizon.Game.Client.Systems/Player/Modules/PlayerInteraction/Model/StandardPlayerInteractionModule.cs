        ...
        RunInteractionEventObserver
{
    ...
    public StandardPlayerInteractionModule(IPlayerEntity playerEntity)
    {
    ...
    public Task Handle(EntityLeftInteractionDistanceEvent args)
    {
        _distanceEntityMap.Remove(args.Entity.EntityId);
        return CalculateFocus();
    }

    public async Task Handle(RunInteractionEvent args)
    {
    ...
    private async Task CalculateFocus()
    {
        ...
        await _mediator.Publish(new ClearInteractionIndicatorEvent());
    }
    ...
    private struct InteractionItem
    {
        ...
        public InteractionItem(IObjectEntity entity, decimal distanceToPlayer)
        {
            Entity = entity;
