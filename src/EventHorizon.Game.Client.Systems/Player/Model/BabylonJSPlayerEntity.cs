...
public class BabylonJSPlayerEntity : StandardServerEntity, IPlayerEntity
{
    public IPlayerZoneDetails PlayerDetails { get; }

    public BabylonJSPlayerEntity(IPlayerZoneDetails player)
        : base(player)
    {
    ...
    public override async Task Initialize()
    {
        ...
        RegisterModule(
            ...
            new StandardPlayerInteractionModule(this)
        );

        await _mediator.Send(new RegisterAllPlayerModulesOnEntityCommand(this));
    }
}
