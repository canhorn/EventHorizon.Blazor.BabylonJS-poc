namespace EventHorizon.Game.Client.Systems.Player.ClientAction
{
        ...
        : INotificationHandler<ClientActionPlayerSystemReloadedEvent>
    {
        ...
        public ClientActionPlayerSystemReloadedEventHandler(
        ...
        ) => _observer.Trigger<ClientActionPlayerSystemReloadedEventObserver, ClientActionPlayerSystemReloadedEvent>(
            notification,
            cancellationToken
        );
    }
