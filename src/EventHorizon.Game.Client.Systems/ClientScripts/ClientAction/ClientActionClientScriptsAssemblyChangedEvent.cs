...
public struct ClientActionClientScriptsAssemblyChangedEvent : IClientAction
{
    ...
    : INotificationHandler<ClientActionClientScriptsAssemblyChangedEvent>
{
    ...
    public Task Handle(
        ...
        _observer.Trigger<
            ClientActionClientScriptsAssemblyChangedEventObserver,
            ClientActionClientScriptsAssemblyChangedEvent
