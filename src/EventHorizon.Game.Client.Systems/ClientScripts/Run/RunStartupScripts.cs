...
public record RunStartupScripts(IEnumerable<IStartupClientScript> StartupScripts)
    : IRequest<StandardCommandResult>;

public class RunStartupScriptsHandler : IRequestHandler<RunStartupScripts, StandardCommandResult>
{
    ...
    )
    {
        ...
        {
            await script.Run(_scriptServices, new ScriptData(new Dictionary<string, object>()));
        }
