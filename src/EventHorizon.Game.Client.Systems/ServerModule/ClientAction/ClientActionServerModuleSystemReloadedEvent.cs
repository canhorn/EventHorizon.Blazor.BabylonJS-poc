namespace EventHorizon.Game.Client.Systems.ServerModule.ClientAction
{
    ...
    public struct ClientActionServerModuleSystemReloadedEvent
        : IClientAction
    {
        ...
        {
            ServerModuleScriptsList = resolver.Resolve<List<ServerModuleScriptsModel>>("serverModuleScriptList");
        }
    }
        ...
        : INotificationHandler<ClientActionServerModuleSystemReloadedEvent>
    {
        ...
        ) => _observer.Trigger<ClientActionServerModuleSystemReloadedEventObserver, ClientActionServerModuleSystemReloadedEvent>(
            notification,
            cancellationToken
        );
    }
