...
public struct MapMeshHitEvent : INotification
{
    ...
    public MapMeshHitEvent(IVector3 poisition)
    {
        Poisition = poisition;
    }
}

public interface MapMeshHitEventObserver : ArgumentObserver<MapMeshHitEvent> { }

public class MapMeshHitEventHandler : INotificationHandler<MapMeshHitEvent>
{
    private readonly ObserverState _observer;

    public MapMeshHitEventHandler(ObserverState observer)
    {
        _observer = observer;
    }
