namespace EventHorizon.Game.Client.Systems.Dialog.Model
{
    ...
    public class DialogTreeNodeModel
        : DialogTreeNode
    {
        public string TitleKey { get; set; } = string.Empty;
        public Dictionary<string, object> TitleData { get; set; } = new Dictionary<string, object>();
        ...
        public List<DialogTreeActionNodeModel> Actions { get; set; } = new List<DialogTreeActionNodeModel>();
