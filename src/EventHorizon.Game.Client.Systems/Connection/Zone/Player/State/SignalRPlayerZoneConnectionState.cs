...
public class SignalRPlayerZoneConnectionState : IPlayerZoneConnectionState
{
    ...
    public Task StartConnection(string serverUrl, string accessToken)
    {
        if (_connection != null)
        {
    ...
    public async Task InvokeMethod(string methodName, IList<object> data)
    {
    ...
    ) where T : class
    {
        ...
        return _connection.InvokeCoreAsync<T>(methodName, data.ToArray());
    }
}
