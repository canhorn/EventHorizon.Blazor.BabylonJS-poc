namespace EventHorizon.Game.Client.Systems.Connection.Zone.Player.Info
{
    ...
    public struct PlayerZoneInfoReceivedEvent : INotification
    {
        ...
        public PlayerZoneInfoReceivedEvent(
            IPlayerZoneInfo playerZoneInfo
        )
        {
    ...
    public class PlayerZoneInfoReceivedEventHandler
        : INotificationHandler<PlayerZoneInfoReceivedEvent>
    {
        private readonly ObserverState _observer;

        public PlayerZoneInfoReceivedEventHandler(
