...
public interface AccessTokenSetEventObserver : ArgumentObserver<AccessTokenSetEvent> { }

public class AccessTokenSetEventObserverHandler : INotificationHandler<AccessTokenSetEvent>
{
