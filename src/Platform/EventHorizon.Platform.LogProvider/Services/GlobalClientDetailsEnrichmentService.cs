    ...
    : ClientDetailsEnrichmentService
{
    ...
    public void EnrichReference(IDictionary<string, object> data)
    {
        ...
        EnrichWithActivity(data);
    }

    public void EnrichWith(string key, string value)
    {
        _values[key] = value;
    }

    public void EnrichWith(string key, bool value)
    {
        _values[key] = value;
    }

    private static void EnrichWithActivity(IDictionary<string, object> data)
    {
