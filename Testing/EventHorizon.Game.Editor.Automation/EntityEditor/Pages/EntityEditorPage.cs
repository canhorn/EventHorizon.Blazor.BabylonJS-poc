...
public class EntityEditorPage : MainLayoutPage<_>
{
    ...
    public StandardToolbarComponent<_, StandardToolbarButtonComponent<_>> ClientEntityToolbar
    {
        get;
        private set;
    }
    ...
    public StandardToolbarComponent<_, StandardToolbarButtonComponent<_>> AgentEntityToolbar
    {
        get;
        private set;
    }
