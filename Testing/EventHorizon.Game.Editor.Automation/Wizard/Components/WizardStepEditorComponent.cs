...
public class WizardStepEditorComponent<TOwner> : Control<TOwner>
    where TOwner : PageObject<TOwner>
{
    ...
    public WizardStepEditorToolbar Toolbar { get; private set; }

    [FindByClass("wizard-step-editor__toolbar")]
    public class WizardStepEditorToolbar : Control<TOwner>
    {
        ...
        public Button<TOwner> Cancel { get; private set; }
    }
