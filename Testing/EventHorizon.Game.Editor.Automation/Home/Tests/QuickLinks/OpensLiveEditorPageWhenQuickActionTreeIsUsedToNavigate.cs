...
public class OpensLiveEditorPageWhenQuickActionTreeIsUsedToNavigate : WebHost
{
    [Test]
    ...
    public void Opens_Live_Editor_Page_When_Quick_Action_Tree_Is_Used_To_Navigate()
    {
        this.Login<HomePage>()
            ...
            .Children.Should.Contain(a => a.Text == Translations.EN_US.LiveEditorText)
            .SideBar.QuickLinks.Tree.Children.First(a =>
                a.Text == Translations.EN_US.LiveEditorText
            )
            .Link.ClickAndGo<LiveEditorPage>()
            .Header.Should.Be(LiveEditorPageTranslations.EN_US.Header);
    }
}
