namespace EventHorizon.Game.Editor.Zone.Services.Connection
{
    ...
    public struct ZoneAdminServiceReconnectingEvent
        : INotification
    {
        public string ZoneId { get; }

        public ZoneAdminServiceReconnectingEvent(
            string zoneId
        )
        {
            ZoneId = zoneId;
        ...
        : INotificationHandler<ZoneAdminServiceReconnectingEvent>
    {
        ...
        ) => _observer.Trigger<ZoneAdminServiceReconnectingEventObserver, ZoneAdminServiceReconnectingEvent>(
            notification,
            cancellationToken
        );
    }
