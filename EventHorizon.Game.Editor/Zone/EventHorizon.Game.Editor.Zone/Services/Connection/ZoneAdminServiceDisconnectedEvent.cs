namespace EventHorizon.Game.Editor.Zone.Services.Connection
{
    ...
    public struct ZoneAdminServiceDisconnectedEvent
        : INotification
    {
        public string ZoneId { get; }
        public string ReasonCode { get; }

        public ZoneAdminServiceDisconnectedEvent(
            string zoneId,
            string reasonCode
        )
        {
        ...
        : INotificationHandler<ZoneAdminServiceDisconnectedEvent>
    {
        ...
        ) => _observer.Trigger<ZoneAdminServiceDisconnectedEventObserver, ZoneAdminServiceDisconnectedEvent>(
            notification,
            cancellationToken
        );
    }
