namespace EventHorizon.Game.Editor.Zone.Editor.Services.Save
{
    ...
    public struct SavedEditorFileContentSuccessfulyEvent
        : INotification
    {
        ...
        : INotificationHandler<SavedEditorFileContentSuccessfulyEvent>
    {
        ...
        public SavedEditorFileContentSuccessfulyEventObserverHandler(
        ...
        ) => _observer.Trigger<SavedEditorFileContentSuccessfulyEventObserver, SavedEditorFileContentSuccessfulyEvent>(
            notification,
            cancellationToken
        );
    }
