namespace EventHorizon.Game.Editor.Zone.AdminClientAction.State
{
    ...
    public class StandardAdminClientActionState
        : AdminClientActionState
    {
        ...
        )
        {
            try
            {
                ...
                ))
                {
                    return Activator.CreateInstance(
                        actionType,
                        new AdminClientActionDataResolver(
                            data
                        )
                    )!.To<IAdminClientAction>()!.ToOption();
                }
            }
            catch (Exception ex)
            {
            ...
            return new Option<IAdminClientAction>(
                null
            );
        }
    }
