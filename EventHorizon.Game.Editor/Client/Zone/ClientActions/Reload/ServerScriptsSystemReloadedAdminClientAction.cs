namespace EventHorizon.Game.Editor.Client.Zone.ClientActions.Reload
{
    ...
    public struct ServerScriptsSystemReloadedAdminClientAction
        : IAdminClientAction
    {
        ...
        : INotificationHandler<ServerScriptsSystemReloadedAdminClientAction>
    {
        ...
        ) => _observer.Trigger<ServerScriptsSystemReloadedAdminClientActionObserver, ServerScriptsSystemReloadedAdminClientAction>(
            notification,
            cancellationToken
        );
    }
