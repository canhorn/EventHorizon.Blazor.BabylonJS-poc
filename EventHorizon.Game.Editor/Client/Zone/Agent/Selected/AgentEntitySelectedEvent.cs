namespace EventHorizon.Game.Editor.Client.Zone.Agent.Selected
{
    ...
    public struct AgentEntitySelectedEvent
        : INotification
    {
        public IObjectEntityDetails Entity { get; }

        public AgentEntitySelectedEvent(
        ...
        : INotificationHandler<AgentEntitySelectedEvent>
    {
        ...
        public AgentEntitySelectedEventObserverHandler(
        ...
        ) => _observer.Trigger<AgentEntitySelectedEventObserver, AgentEntitySelectedEvent>(
            notification,
            cancellationToken
        );
    }
