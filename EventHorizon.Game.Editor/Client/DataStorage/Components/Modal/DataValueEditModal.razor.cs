namespace EventHorizon.Game.Editor.Client.DataStorage.Components.Modal
{
    ...
    public class DataValueEditModalBase
        : EditorComponentBase
    {
        [Parameter]
        ...
        public DataValueEditModalModel EditingModel { get; private set; } = new DataValueEditModalModel();
        ...
        public void HandleDataNameChanged(
        ...
        public void HandleValueTypeChanged(
        ...
        )
        {
            ...
            EditingModel = EditingModel.ChangeValueType(
                option.Value,
                DataStoreMetadata.GetDefaultValueForPropertyType(
                    dataType
                )
            );
