        ...
        ZoneAdminServiceConnectedEventObserver
{
    ...
    public DataStorePropertiesMetadata DataStoreMetadata { get; private set; } =
    ...
    public DataValueEditModalModel EditModalModel { get; private set; } =
        new(string.Empty, string.Empty, ZoneEditorPropertyType.PropertyString);
    ...
    public async Task HandleDataValueEditSubmit(DataValueModalSubmitArgs args)
    {
