namespace EventHorizon.Game.Editor.Client.DataStorage.Components.Modal
{
    ...
    public struct DataValueEditModalModel
    {
        ...
        public DataValueEditModalModel(
            string name,
            object value,
            string type
        )
        ...
        internal DataValueEditModalModel UpdateName(
            string name
        )
        {
            DataName = name;
        ...
        )
        {
            ...
            DataValue = value;
            DataType = type;
            DataTypeOption = PropertyTypeOptions.First(
                a => a.Value == type
            );
        ...
        internal DataValueEditModalModel UpdateValue(
            string name,
            object value
        )
        {
        ...
        internal DataValueEditModalModel ChangeValueType(
            string type,
            object value
        )
        {
        ...
        internal DataValueEditModalModel UpdateErrorCode(
            string errorCode
        )
        {
