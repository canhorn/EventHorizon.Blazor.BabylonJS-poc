namespace EventHorizon.Game.Editor.Client.AssetManagement.Pages
{
        ...
        ZoneAdminServiceConnectedEventObserver
    {
        ...
        protected IEnumerable<ClientAsset> GameAssetList { get; private set; } = new List<ClientAsset>();
        ...
        protected void HandleEditGameAsset(
            string id
        )
        {
            NavigationManager.NavigateTo(
                $"/asset/management/zone/edit/{id}"
            );
        }
        ...
        protected void HandleDeleteGameAsset(
